...
let TTS_VOICE_LIST = [
  { id: "hoaimy", label: "Hoài My — nữ, chuẩn", group: "Giọng Việt gốc (tự nhiên nhất)" },
  { id: "namminh", label: "Nam Minh — nam, chuẩn", group: "Giọng Việt gốc (tự nhiên nhất)" },
];
...
function makeTtsBox(onVoice, { placeholder = "Dán kịch bản/lời thoại ở đây → bấm Tạo giọng AI" } = {}) {
  ...
  // Dựng dropdown CHIA NHÓM (Giọng Việt gốc / Giọng đa ngôn ngữ).
  const fill = () => {
    const cur = sel.value;
    const groups = [];
