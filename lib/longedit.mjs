...
import { FFMPEG, probe, detectSilences, hasNvenc } from "./ffmpeg.mjs";
import { transcribeWords, buildAssCaptions, saveAss } from "./transcribe.mjs";
import { assFilter } from "./fonts.mjs";
import { colorGrade, manualColor, smoothFilter, filmLook, voiceCleanFilter, logoScaleFilter } from "./effects.mjs";
...
export async function longEdit(inputs, opts = {}) {
  const {
    ...
    colorLevel = "medium", manual = null, smooth = "off", film = false,
  ...
  return { aspect, parts, transcriptText };
}
