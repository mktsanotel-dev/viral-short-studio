...
export async function cleanVoice(input, opts = {}) {
  ...
  // ⏩ Đổi tốc độ bằng rubberband: GIỮ NGUYÊN cao độ giọng (không "chuột"), giữ phụ âm sắc nét,
  // sạch & tự nhiên hơn atempo. Đây là bộ lọc tab Nội thất đang dùng nên chắc chắn build có.
  if (Math.abs(t - 1) > 0.001) af.push(`rubberband=pitch=1.0:tempo=${t.toFixed(3)}`);
