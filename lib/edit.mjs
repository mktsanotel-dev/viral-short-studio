...
import { colorGrade, manualColor, motionZoompan, filmLook, progressBar, brollNormalize, flashEnable, logoScaleFilter, logoPosition, logoPositionXY, smoothFilter, voiceCleanFilter } from "./effects.mjs";
...
export async function autoEdit(input, opts = {}) {
  const {
    ...
    colorLevel = "medium", manual = null, smooth = "off", punch = true, shake = true, film = true,
